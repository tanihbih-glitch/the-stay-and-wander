...
- [ ] Obtain the missing full Tokyo and Seoul article copy referenced by the attachment before creating `/blog/where-to-stay-in-tokyo-2026` and `/blog/where-to-stay-in-seoul-2026`.
- [ ] Publish the Tokyo and Seoul guides with exact title-matching metadata, the existing live Trip.com hotel widget, the supplied city-specific Things to Do widget placement, Blog listing entries, routes, SSR metadata, and sitemap records.
- [ ] Create reciprocal internal links among Bali, Bangkok, Tokyo, and Seoul where-to-stay guides, and from the Tokyo vs Bangkok article to the relevant Tokyo and Bangkok guides.
- [ ] Add regression coverage, verify desktop/mobile rendering, SEO, widgets, routes, sitemap, and cross-links, then save a checkpoint after all four guides are complete. Focused SEO regression and TypeScript validation for the completed Bali/Bangkok updates are passing.
