...
- [ ] Run regression and HTTP behavior checks for the nine URLs, sitemap, and unaffected routes; publish the remediation and report the outcome. Local redirect checks and the complete 86-test suite are passing; publish and custom-domain verification remain.
