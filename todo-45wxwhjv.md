...
- [ ] Establish a compliant CTR-monitoring workflow for the four where-to-stay guides using Search Console performance data, including a repeatable review cadence and baseline metrics rather than FAQ rich-result expectations.
...
- [ ] Validate the data access and schedule, document the report cadence and monitored URLs, and publish the completed FAQ/itinerary/monitoring enhancement checkpoint.
- [ ] Publish the completed Tokyo and Seoul FAQ and itinerary enhancements now; defer the read-only Search Console connection and monthly CTR schedule until the user supplies OAuth credentials through the secure flow.
