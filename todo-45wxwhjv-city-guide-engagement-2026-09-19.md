# City Guide Engagement and Navigation — 2026-09-19

- [x] Audited the canonical Bali, Bangkok, Tokyo, and Seoul hotel price/stay guides, existing route metadata, related-card component, analytics dashboard, and privacy policy.
- [x] Add a deliberately anonymous related-guide click-event model, an admin engagement summary, and a visible privacy-policy explanation.
