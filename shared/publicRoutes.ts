...
export const sitemapRoutes: readonly SitemapRoute[] = [
  ...
  { path: "/itinerary/tokyo", lastmod: "2026-08-12", changefreq: "monthly", priority: 0.8 },
  ...
  { path: "/blog/where-to-stay-in-bali-2026", lastmod: "2026-08-17", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/where-to-stay-in-bangkok-2026", lastmod: "2026-08-17", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/bangkok-hotel-budget-breakdown-2026", lastmod: "2026-08-17", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/bangkok-hotel-price-index-2026", lastmod: "2026-08-24", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/bangkok-airport-hotels-2026", lastmod: "2026-08-17", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/uae-extended-stay-hotels-2026", lastmod: "2026-09-16", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/uae-extended-stay-sustainability-2026", lastmod: "2026-08-17", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/where-to-stay-in-tokyo-2026", lastmod: "2026-08-12", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/where-to-stay-in-seoul-2026", lastmod: "2026-08-12", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/seoul-food-price-index-2026", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8 },
  ...
  { path: "/blog/bali-beach-comparison-matrix-2026", lastmod: "2026-08-22", changefreq: "monthly", priority: 0.8 },
  { path: "/blog/bali-spa-wellness-price-index-2026", lastmod: "2026-08-23", changefreq: "monthly", priority: 0.8 },
