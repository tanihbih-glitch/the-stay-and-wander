...
const priceTiers = [
  { id: "seoul-value-tier", label: "Value-oriented districts", range: "$30–$150+/night", description: "The guide's directional ranges put Hongdae ($30–$130+), Insadong ($30–$140+), and Itaewon ($35–$150+) in the stronger-value city-base group." },
  { id: "seoul-central-tier", label: "Central first-timer stays", range: "$40–$160+/night", description: "Myeongdong's published $40–$160+ range balances central sightseeing, shopping, street food, and straightforward first-time navigation." },
