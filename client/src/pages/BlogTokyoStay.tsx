...
const priceTiers = [
  { id: "tokyo-value-tier", label: "Value-oriented bases", range: "$35–$160+/night", description: "The published snapshot places Asakusa at $35–$150+ and Ikebukuro at $40–$160+, pairing stronger value with traditional character or major-station convenience." },
  { id: "tokyo-central-tier", label: "Central city energy", range: "$50–$210+/night", description: "Shinjuku ($50–$200+) and Shibuya ($55–$210+) are the directional planning bands for high-energy, rail-connected first-time bases." },
