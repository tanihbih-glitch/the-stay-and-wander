...
import { buildBaliSeasonalAvailabilityUrl, getNextBaliSeasonalSearchDates } from "@/lib/affiliateLinks";
...
export default function BaliSeasonalRateChart() {
  ...
  const dates = getNextBaliSeasonalSearchDates(selectedMonthIndex);
