...
const vehicleOptions = [
  { id: "sedan", label: "Sedan", capacity: "1–3 travelers", maxTravelers: 3, multiplier: 1 },
  { id: "minivan", label: "Minivan", capacity: "4–6 travelers", maxTravelers: 6, multiplier: 1.55 },
  { id: "bus", label: "Minibus / Bus", capacity: "7–12 travelers", maxTravelers: 12, multiplier: 2.2 },
] as const;
