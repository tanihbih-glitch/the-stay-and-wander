...
/**
 * PopularRoutesWidgetItinerary Component
 * Embeds Travelpayouts Popular Routes widget on itinerary detail pages
 * Shows 6 trending flight routes with affiliate tracking
 */

export default function PopularRoutesWidgetItinerary() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full bg-white rounded-lg p-6 border border-gray-200"
      style={{
        minHeight: "400px",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      <div className="text-center text-gray-600">
        <p className="text-lg font-semibold">Loading flight options...</p>
        <p className="text-sm mt-2">
          Finding the best deals to your destination
        </p>
      </div>
    </div>
  );
